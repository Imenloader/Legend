...
const MYTH_HEROES = {
    ...
    achilles: {
        ...
        dialogue: {
            ...
            victory: ['"ده اللي القدر كاتبه لينا. النصر. دايماً النصر والتمكين!"'],
    ...
    // ── أبطال العهد والسيادة الأسطوريين ──
    sigurd: {
        id: 'sigurd',
        name: 'فهد قاهر التنانين',
        title: 'فارس الغدران وصاحب سيف الجلال الباطني',
        ...
        dialogue: {
            greet: [
                ...
                '"القدر مكتوب ومسطر، بس السيف في إيدينا. ياللا بينا."'
            ],
            battle_cry: ['"باسم الحق والعدل والنور السماوي!"', '"بسيف الجلال — موووت!"'],
            victory: ['"سقط التنين وعاد النور لربوعه. زي ما كل شر لازم ينتهي كدة."', '"أخيراً.. طهرنا الأرض من وساوسهم."'],
            defeat: ['"حتى الفرسان بيقعوا.. بس مش للأبد. الهمة هترجع أقوى."'
            ]
        },
        passiveBuff: {
    ...
    scheherazade: {
        ...
        dialogue: {
            greet: [
                '"كان ياما كان، في قديم الزمان.. بطل بدني افتكر إن رحلته ملهاش نهاية.. تحب نكمل حكايتك سوا؟"',
        ...
        passiveBuff: {
            label: '+20 عزيمة بدنية قصوى، وفتح حوارات ونتائج إضافية طيبة (صوت الألف ليلة)',
    ...
    rustam: {
        ...
        affinity: 50,
        personality: 'noble',
        description: 'أعظم بطل في ملاحم الشرق، حارب لقرون مع حصانه البرق وسيفه الأثير. هزم شيطان الفوضى الأبيض، ونجا من المحن السبعة العظيمة بالصحرا، وصارع القدر نفسه بالحق وديوان العدالة.',
        dialogue: {
            greet: [
    ...
    imhotep: {
        ...
        affinity: 50,
        personality: 'wise',
        description: 'الرجل الصالح العارف بمسار الخلود اللي خُلد اسمه وحكمته لآلاف السنين. اخترع الطبابة والأعشاب، وبنى عواميد قلاع ودواوين الحكمة، وكتب وصايا وحكم خلدتها النفوس والهمم. سلاحه الحقيقي هو العلم والبركة. ودرعه هو البصيرة والسكينة.',
        dialogue: {
            greet: [
                '"علمتني العواميد القديمة حاجة واحدة: كل بناء عظيم بيحتاج أساس بدني ثابت. خلينا نبني نصرك."',
                '"الطب، البناء، الفلسفة الطبيعية والطبية — أتقنتهم كلهم. والقتال والدفاع؟ مجرد فن وعلم تالت هندرسه وننصره بالحق."'
            ],
            battle_cry: ['"العلم والبركة هما أمضى سلاح!"', '"ببركة الحكمة والأنوار — اندفعوا بالحق!"'],
            victory: ['"تطبيق سليم ومبارك للحكمة البدنية. كالعادة في طريق الأبرار."'],
            defeat: ['"كل خطأ بيعلم صاحبه حكمة. كسبنا بصيرة ونور النهاردة، متزعلش."'
            ]
        },
        passiveBuff: {
            label: 'رجوع كامل للصحة والعزيمة مرة واحدة في كل عهد (طبابة لقمان)',
            effect: (state) => {}
        },
        uniqueAbility: {
            ...
            description: 'ترجع صحتك وعزيمتك بالكامل مرة واحدة في كل عهد. بركة من أعظم الأوراد الطبية العتيقة.'
        }
    },
    shango: {
        id: 'shango',
        ...
        affinity: 50,
        personality: 'fierce',
        description: 'مارد الجن الناري الجبار اللي بيتحكم في الرعد والصواعق وطبول المعارك البدنية. شعلان سريع كعاصفة، ومخيف كبرق السما، وحاسم ضد أي ظلم وفساد بقنوات النور.',
        dialogue: {
            greet: [
...
const EXTRA_ARABIAN_HEROES = {
    sinbad: {
        ...
        dialogue: {
            ...
            defeat: ['"...ودي الطريقة اللي رحلتي التامنة كانت هتخلص بيها.. بس لسة الهمة باقية والنفس فيها نبض!"'
            ]
        },
        passiveBuff: {
            label: '+25% غنائم فخمة، والمناطق البحرية والنهارية متسببش أي ضرر بيئي لتركيزك وهمتك (حظ البحار)',
            effect: (state) => {}
        },
        uniqueAbility: {
    ...
    aladdin: {
        ...
        title: 'سيد المصباح السحري ومارد الأماني البدنية',
        origin: 'brass_city',
        sprite: 'assets/sword_immortal_1778872325571.png',
        alignment: 'chaotic_good',
        karmaRequirement: -50,
        ...
        uniqueAbility: {
            ...
            description: 'أمنية بدنية واحدة: ترجع صحتك وعزيمتك بالكامل فورا. تستخدم مرة واحدة في كل معركة.'
        }
    }
};
...
const ENEMY_ARCHETYPES = {
    ...
    mage: { label: 'الباطني الساحر', hint: 'بيفضل السحر والأوراد. واجهه بـ درع سر الجسد الصخري الصلب.' },
