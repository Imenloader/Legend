...
const MYTH_HEROES = {
    ...
    imhotep: {
        ...
        affinity: 50,
        personality: 'wise',
        description: 'الرجل الصالح العارف بالله اللي خُلد اسمه وحكمته لآلاف السنين. اخترع الطبابة والأعشاب، وبنى عواميد قلاع ودواوين العبادة، وكتب وصايا وحكم خلدتها الأرواح. سلاحه الحقيقي هو العلم والبركة. ودرعه هو البصيرة والسكينة.',
        dialogue: {
            greet: [
