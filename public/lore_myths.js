...
const MYTH_HEROES = {
    ...
    scheherazade: {
        ...
        passiveBuff: {
            label: '+20 مانا بدنية قصوى، وفتح حوارات ونتائج إضافية طيبة (صوت الألف ليلة)',
...
const EXTRA_ARABIAN_HEROES = {
    ...
    aladdin: {
        ...
        uniqueAbility: {
            ...
            description: 'أمنية بدنية واحدة: ترجع صحتك ومانتك بالكامل فورا. تستخدم مرة واحدة في كل معركة.'
        }
    }
};
