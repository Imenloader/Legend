...
window.SHOP = {
    ...
    stocks: {
        ...
        jade_sect_shop: [
            ...
            { id: 'jade_charm', name: 'Jade Charm', price: 500, type: 'relic', stats: { def: 15, mp: 20 }, desc: 'A basic protective charm.' },
            { id: 'disciple_sword', name: 'Disciple Sword', price: 800, type: 'weapon', stats: { atk: 25 }, desc: 'Standard issue jade sect blade.' }
        ],
        sufi_bazaar: [
            { id: 'empty_quarter_dates', name: 'Sacred Dates', price: 60, type: 'consumable', desc: 'Restores 40 HP and 20 Qi.', effect: { hp: 40, mp: 20 } },
            { id: 'prayer_beads', name: 'Tasbih of Peace', price: 600, type: 'relic', stats: { mp: 50, def: 10 }, desc: 'Beads that calm the spirit.' },
            { id: 'sufi_tunic', name: 'Woolen Tunic', price: 450, type: 'body', stats: { def: 20, hp: 30 }, desc: 'Simple but resilient clothing.' }
        ]
    },
