...
const ARABIAN_HEROES = {
    tariq_ibn_ziyad: {
        ...
        dialogue: {
            ...
            battle_cry: ['"احرقوا السفن! للآمااام بالحق!"', '"النصر أو الشهادة والخلود — الطرتركيز وهمة فيهم شرف كبير!"'],
    ...
    harun_al_rashid: {
        ...
        dialogue: {
            greet: [
                '"حبر العلماء والكتب البدنية أطهر عند الله من دم الفرسان. افتكر ده كويس قبل ما تسحب سيفك."',
    ...
    fatima_al_fihri: {
        ...
        title: 'أم المعارف ومؤسسة ديوان الكيمياء والعلوم البدنية',
        origin: 'crossroads',
        sprite: 'assets/sufi_mystic_1778872363338.png',
        alignment: 'lawful_good',
        karmaRequirement: 10,
        ...
        description: 'بنت أول جامعة ومدرسة علوم وقلعة وديوان للطب بالمعمورة. مبتحاربش بالسيوف الحادة — هي بتحارب بالبصيرة والعلم الإلهي النقي. بتفتح ورشة الكيمياء والأعشاب.',
        dialogue: {
            greet: [
                '"العلم والتركيز وهمة هما الحاجة الوحيدة اللي مفيش مخلوق يقدر ياخدها منك بالقوة. تحب أعلمك؟"',
            ...
            high_affinity: '"أسئلتك بقت أعمق وأحسن في كل مرة بنتقابل. ده دليل إن تركيزك وهمتك بدأت ترتقي للعلم الصافي."'
        },
        passiveBuff: { stat: 'mp', bonus: 0.25, label: '+25% مانا بدنية قصوى. تفتح وصفات كيميائية نادرة بموقد الكيمياء.' },
        uniqueAbility: {
...
const ARABIAN_ENEMIES = {
    ...
    sand_wraith: {
        ...
        nonCombatOption: 'لو قرأت مذكرات رحال قديم وعرفت اسمه وندهت عليه، الطيف بيهدى ويروح لربنا بسلام ويديك كنز بدني وكارما عالية.',
