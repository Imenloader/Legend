...
window.PETS = {
    ...
    beasts: {
        'desert_jinn': { id: 'desert_jinn', name: 'ذئب الصحراء الأليف المطيع', rarity: 'نادر', type: 'بدني', bonus: { atk: 0.1, mp: 20 }, skill: 'إعصار رمال الفتوة', desc: 'دوامة قتالية من الرمل والعزيمة الحامية في جوف الصحراء.' },
        'jade_qilin': { id: 'jade_qilin', name: 'المهر المجنح الأسطوري البارق', rarity: 'أسطوري', type: 'أسطوري', bonus: { def: 0.15, hp: 50 }, skill: 'النظرة الباسلة المباركة', desc: 'دابة وفية بتهبط من أعلى القمم لتجلب النصر والسكينة لصاحبها.' },
        ...
        'saluki_hound': { id: 'saluki_hound', name: 'كلب السلوقي العربي السريع', rarity: 'غير مألوف', type: 'صيد', bonus: { atk: 0.06, speed: 20 }, skill: 'انقضاض الصيد الخاطف', desc: 'كلب صيد عربي أصيل يركض كالسهم المارق ويفزع غزلان الفيافي ووحوش الرمال.' },
