...
window.PETS = {
    ...
    beasts: {
        'desert_jinn': { id: 'desert_jinn', name: 'ذئب الصحراء الأليف المطيع', rarity: 'نادر', type: 'بدني', bonus: { atk: 0.1, mp: 20 }, skill: 'إعصار رمال الفتوة', desc: 'دوامة قتالية من الرمل والمانا الحامية في جوف الصحراء.' },
