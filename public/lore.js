...
const REGIONS = {
    ...
    brass_city: {
        ...
        description: 'المدينة الأسطورية المدفونة تحت رمال الربع الخالي، اللي ظهرت تاني بسبب زلزال روحاني عظيم. عواميدها بتلمس السما. وحاكمها، ملك المردة القديم "مُرقَباد"، اختفى من قرون وساب كنوزه محروسة بالطلسم.',
        stageRange: [8, 12],
        unlocked: false,
        ambientColor: '#8a1c1c',
    ...
    celestial_court: {
        ...
        subtitle: 'حيث يُقضى بالحق وتُوزن الأرواح',
        description: 'فوق السحاب، بعيد عن عيون البشر العاديين. السلطان الأسطوري قاعد على عرش من النور والنجم الساطع. مجلس الحكماء وأولياء الله الصالحين واقفين قدامه. الأرض والسما في فتنة عظيمة، ومفيش غيرك يقدر يقرر إيه اللي هيحصل بعد كدة.',
        stageRange: [12, 15],
        unlocked: false,
        ambientColor: '#d4af37',
...
const CHINESE_HEROES = {
    sun_wukong: {
        id: 'sun_wukong',
        name: 'صخر المارد الجبار',
        title: 'سيد نيران المرصاد والصلابة الحرة',
        ...
        dialogue: {
            greet: [
                '"يا مرحب بالسالك! صخر كان مستنيك.. ريحتك فيها سر وسحر، بس برضه فيها تراب السكة!"',
            ...
            battle_cry: [
                ...
                '"اضرب بسرعة! صخر المارد هيحمي ضهرك — إلا لو ظهرت حاجة بتلمع تشتت انتباهي!"',
            ...
            low_affinity: '"لو فضلت تتصرف بكبرياء كدة، صخر هيسيبك ويروح يدور على سالك دمه خفيف يسلي وقته!"',
            death_line: '"حتى... صخر الجبار... انطفت... شعلته..."'
        },
        passiveBuff: { stat: 'atk', bonus: 0.20, label: '+20% للهجوم' },
        uniqueAbility: {
            name: 'طلسم التشكل الروحاني',
            mpCost: 25,
    ...
    guan_yu: {
        id: 'guan_yu',
        name: 'طارق الفارس الأبي',
        title: 'حارس حديد دمشق وصاحب العهد والميثاق',
        origin: 'crossroads',
        ...
        dialogue: {
            greet: [
                '"روحانياتك متلخبطة يا سالك. قلبك لسة مخدش قراره. ارجعلي لما تعرف طريقك وحقيقتك بجد."',
                '"قابلت آلاف الفرسان في طريقي. قليلين اللي عيونهم فيها نفس اللمعة والنقاء اللي عندك. أوعى تضيعهم."'
            ],
            battle_cry: [
                '"باسم الحق والعدل الأزلي!"',
        ...
        secretMotivation: 'المجلس السلطاني الأعلى كلفه يراقب السالكين ويشوف مين فيهم وفي لعهود الله ويستحق الترقي لرتبة الولاية والولاية العظمى.'
    },
    hua_mulan: {
        id: 'hua_mulan',
        name: 'ياسمين فخر الفرسان',
    ...
    ne_zha: {
        id: 'ne_zha',
        name: 'شهاب الفتى اللهبي',
        title: 'مولود النيران والروح المتمردة المتجددة',
        origin: 'empty_quarter',
    ...
    nuwa: {
        id: 'nuwa',
        name: 'الشيخة زبيدة العارفة',
        title: 'أم السالكين ومصلحة القلوب بنور الله',
        ...
        description: 'شيخة عارفة بالله صالحة، قضت عمرها تصلح النفوس وتلم شمل التايهين في الصحراء. مبدخلش في خناقات البشر بسهولة، بس لو اتكلمت الكل بيسمع لهيبتها وبركتها.',
        dialogue: {
            greet: [
    ...
    zhuge_liang: {
        id: 'zhuge_liang',
        name: 'الحكيم الطغرائي',
        title: 'صاحب البصيرة وتدبير الحيل والخطط',
        origin: 'crossroads',
...
const CHINESE_ENEMIES = {
    ...
    dragon_carp: {
        ...
        moves: {
            ...
            magic: { name: 'إعصار النور الناري المحرق', text: 'بتطلق لهب أبيض صافي من روحها بيحوطك ويحرق طاقتك.' }
        },
    ...
    fallen_disciple: {
        ...
        nonCombatOption: 'سالك شيخ عارف يقدر يقدم ليه إكسير إصلاح القنوات ويصلح روحه، وهيتحول لرفيق شاكر ويديك كنزه بسلام.',
...
window.EQUIPMENT_DATA = {
    ...
    gungnir_replica: { id: 'gungnir_replica', name: 'رمح الرمي الصائب المستهدف لنقاط الضعف والعظام', slot: 'weapon', set: 'mythology', quality: 'Elite', stats: { atk: 55 }, reqLevel: 14, reqStage: 'Foundation Establishment', desc: 'رمح رمي خفيف من خشب البلوط، مرة ما ترميه بيطير لوحده ويخترق نقاط ضعف العدو مباشرة.' },
    mjolnir_fragment: { id: 'mjolnir_fragment', name: 'شظية مطرقة الرعد والصواعق الجبارة المستقاة', slot: 'relic', set: 'mythology', quality: 'Super', stats: { atk: 45, mp: 50 }, reqLevel: 23, reqStage: 'Core Formation', desc: 'شظية حديدية من مطرقة إله العواصف الغربي، شرارات الكهربا والبرق بتلعلع عليها باستمرار.' }
};
