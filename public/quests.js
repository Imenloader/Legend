...
window.QUESTS = {
    ...
    database: {
        ...
        'daily_gathering': {
            ...
            desc: 'الطائفة والفرسان بحاجة لأعشاب طبية نادرة لتحضير العقاقير الشافية.',
            objective: 'اجمع 5 حزم من أعشاب النور الطبية.',
            type: 'daily',
    ...
    updateQuests(state) {
        ...
        if (newlyCompleted.length > 0) {
            if (typeof narrate === 'function') {
                newlyCompleted.forEach(title => narrate(`<b>تم إنجاز المهمة:</b> ${title}! نزلت البركة والمكافآت على قوتك وحصيلة همتك بنجاح.`, "ديوان الفرسان"));
            }
