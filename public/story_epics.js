...
"من يتجرأ على إزعاج سلاطين وملوك الجان؟ لن تعبر إلا على جثتي المشتعلة!"`,
    ...
    act6_jinn_inner_city: {
        ...
        narration: `جثة المارد النحاسي دابت وتحولت لبركة من النحاس المنصهر. أبواب القصر الأعظم فتحت من تلقاء نفسها، تدعوك لغرفة العرش المظلمة لمواجهة الطاغية الذي أهلكته أوهامه.`,
        choices: [
            { text: 'ادخل القصر الأعظم وتحدى طاغية بابل العتيد', next: 'act6_jinn_king' }
        ]
    },
    ...
    act6_jinn_king: {
        id: 'act6_jinn_king',
        act: 6,
        speaker: 'طاغية بابل العتيد',
        speakerSprite: 'assets/mythology_bg_1778872403707.png',
        narration: `في وسط الغرفة، جالس على عرش من الجماجم النحاسية المشتعلة، طاغية بابل العتيد الممتلئ بالغرور. عينيه زي جمر النار، وهيبته بتخنق الأنفاس.
        
"يا ابن البادية الفاني، كيف تجرؤ على تحدي سلطان عظيم سجدت له القبائل والأمم؟ سأسحق أسطورتك وأجعلك تمثالاً من النحاس في حديقتي!"`,
        choices: [
            { text: '⚔️ أنا فارس الحق وسيف العدل، وسأطفئ نار غرورك بتركيزي الباطني!', next: 'act6_victory', triggerCombat: 'immortal_nimrod', karmaChange: 10 }
        ]
    },
    ...
    act6_victory: {
        ...
        act: 6,
        speaker: 'ديوان الفتوة',
        narration: `الطاغية البابلي صرخ صرخة هزت أركان مدينة النحاس كلها وهو بيتحول لرماد أسود بارد. أخذت من فوق عرشه "تاج النحاس الأسطوري"، حسيت بطاقة مهولة بتسري في عروقك وتضاعف تركيزك البدني!
